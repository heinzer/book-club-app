...
import {faEye, faEyeSlash, faPencil, faPlusCircle, faUsers, faXmark} from '@fortawesome/free-solid-svg-icons';
...
export class AppModule {
  constructor(library: FaIconLibrary) {
    ...
    library.addIcons(faPlusCircle, faUsers, faPencil, faXmark, faEye, faEyeSlash);
  }
}
